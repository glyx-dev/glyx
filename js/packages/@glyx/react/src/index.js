 ...
 *
 * @example
 * glyxWindow.setFullscreen(true);   // game-style fullscreen (covers taskbar)
 * glyxWindow.setMaximized(true);    // maximize (taskbar remains visible)
 * glyxWindow.setMinimized();        // minimize to taskbar
 * glyxWindow.isFullscreen();        // → boolean
 * glyxWindow.isMaximized();         // → boolean
 * glyxWindow.getWindowSize();       // → { width, height } physical pixels
 * glyxWindow.getScreenSize();       // → { width, height } physical pixels
 */
// ── Secure env access ─────────────────────────────────────────────────────────
//
