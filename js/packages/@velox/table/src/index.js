// @velox/table — data table with sortable + resizable columns, selection, and
// virtualized rows (built on @velox/react VirtualizedList + measureText).
//
...
import { View, Text, Pressable, VirtualizedList, measureText, useDraggable } from '@velox/react';
...
function ResizableHeaderCell({ col, width, sorted, dir, onSort, onResize }) {
  ...
  return React.createElement(View, { style: { flexDirection: 'row', alignItems: 'stretch' } },
    ...
    React.createElement(View, {
      _veloxOnMount: onHandle, pressable: true, width: 6, height: 40,
