// @velox/three/src/math.js — column-major 4×4 matrix helpers (no external deps).
//
// Velox's wgpu renderer consumes matrices via `Mat4::from_cols_array(&mesh.transform)`,
