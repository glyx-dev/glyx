# build-windows.ps1
#
# Builds velox-media.dll for Windows x64.
#
# Prerequisites:
...
$OutputName = "velox-media-$Version-windows-x64.dll"
...
$Source = Join-Path $ScriptDir "velox_media.c"
...
Write-Host '  $env:VELOX_MEDIA_SKIP_VERIFY = "1"'
Write-Host "  velox dev"
